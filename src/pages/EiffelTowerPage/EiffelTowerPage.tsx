...
import css from "./EiffelTowerPage.module.scss";
  ...
  return (
    <TeleportReveal>
      <div className={css.hero}>
        ...
        <FlagConfetti src={france} count={200} visible={showConfetti} />
        <div className={css.overlay}>
          ...
          >
            “France has a way of living that is both simple and profound,{" "}
            <span className={css.redSpan}>
              teaching us that life is to be tasted, not hurried.
            </span>
            ”
          </motion.p>
          <img
